      ...
      <form action=''>
        <div className='lg:flex gap-2'>
          <div className='my-2 w-full'>
            <Input {...settings} label={lang.company} />
          </div>
          <div className='my-2 w-full'>
            <Input {...settings} label={lang.year} />
          </div>
        </div>
        <div className='lg:flex gap-2'>
          <div className='my-2 w-full'>
        ...
        <Select
          ...
          defaultValue={lang.program[0]}
          isClearable={true}
          isRtl={language === 'arabic' ? true : false}
          isSearchable={true}
          name='program'
          options={lang.program}
          styles={customStyles}
        />
        <PhoneInput
        ...
        />
        <div className='my-2 w-full'>
          <Input {...settings} label={lang.link} />
        </div>
        <div className='my-2 w-full'>
          ...
          <label
            ...
            <div className='flex flex-col items-center justify-center pt-5 pb-6'>
              ...
              <p className='mb-2 text-sm text-gray-500 dark:text-gray-400'>
                <span className='font-semibold'>{lang.photo.text1}</span>
                {lang.photo.text2}
              </p>
          ...
          <label
            ...
            <div className='flex flex-col items-center justify-center pt-5 pb-6'>
              ...
              <p className='mb-2 text-sm text-gray-500'>
                <span className='font-semibold'>{lang.video}</span>
              </p>
            </div>
            <input id='dropzone-file' type='file' className='hidden' />
          </label>
